...
response = requests.get(
    'https://seamless-sandbox-dev-cm.oriserve.com/fetchCampaignDataOnlyNamesAndAll',
    headers={
        'Accept': 'application/json, text/plain, */*',
        'Origin': 'https://seamless-sandbox-dev-cmdash.oriserve.com'
    }
...
```bash cURL
curl 'https://seamless-sandbox-dev-cm.oriserve.com/fetchCampaignDataOnlyNamesAndAll' \
  -H 'Accept: application/json, text/plain, */*' \
  -H 'Origin: https://seamless-sandbox-dev-cmdash.oriserve.com' \
