...
### cURL:
```bash
curl -X GET "https://seamless-sandbox-dev-cm.oriserve.com/callRecordings?campaign_id=campaign_xyz789&page=1&limit=20" \
...
async function getCallRecordings(filters = {}) {
  const response = await axios.get(
    'https://seamless-sandbox-dev-cm.oriserve.com/callRecordings',
    {
      params: {
