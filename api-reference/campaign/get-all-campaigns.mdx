...
```bash cURL
curl --request GET \
  --url 'https://seamless-sandbox-dev-cm.oriserve.com/fetchCampaignData?limit={limit}&offset={offset}&call_count={call_count}' \
  --header 'Accept: application/json' \
  --header 'Origin: https://seamless-sandbox-dev-cmdash.oriserve.com' \
...
const options = {
  ...
  headers: {
    ...
    'Origin': 'https://seamless-sandbox-dev-cmdash.oriserve.com'
  },
  credentials: 'include'
};

fetch(`https://seamless-sandbox-dev-cm.oriserve.com/fetchCampaignData?limit=${limit}&offset=${offset}&call_count=${callCount}`, options)
