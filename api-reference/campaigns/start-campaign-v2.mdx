...
```bash cURL
curl --request GET \
  --url 'https://seamless-sandbox-dev-cm.oriserve.com/startCampaignv2/{campaignId}' \
...
fetch(`https://seamless-sandbox-dev-cm.oriserve.com/startCampaignv2/${campaignId}`, options)
...
campaign_id = "507f1f77bcf86cd799439013"
url = f"https://seamless-sandbox-dev-cm.oriserve.com/startCampaignv2/{campaign_id}"
