...
### cURL:
```bash
curl -X POST "https://seamless-sandbox-dev-cm.oriserve.com/updateKnowledgeBase" \
...
async function updateKnowledgeBase(filePath) {
  ...
  const response = await axios.post(
    'https://seamless-sandbox-dev-cm.oriserve.com/updateKnowledgeBase',
    form,
    {
      headers: {
        ...form.getHeaders(),
...
def update_knowledge_base(file_path):
    url = "https://seamless-sandbox-dev-cm.oriserve.com/updateKnowledgeBase"
