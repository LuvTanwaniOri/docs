...
### cURL:
```bash
curl -X GET "https://seamless-sandbox-dev-cm.oriserve.com/fetchAccentsAndLanguageFromBackendServer" \
...
async function getAvailableVoices() {
  const response = await axios.get(
    'https://seamless-sandbox-dev-cm.oriserve.com/fetchAccentsAndLanguageFromBackendServer',
    {
      headers: {
