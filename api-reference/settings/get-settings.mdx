...
### cURL:
```bash
curl -X GET "https://seamless-sandbox-dev-cm.oriserve.com/getSettings?user_id=507f1f77bcf86cd799439011" \
...
async function getSettings(userId) {
  const response = await axios.get(
    'https://seamless-sandbox-dev-cm.oriserve.com/getSettings',
    {
