...
### cURL:
```bash
curl -X POST https://seamless-sandbox-dev-cm.oriserve.com/createUser \
...
async function createUser(userData) {
  try {
    const response = await axios.post(
      'https://seamless-sandbox-dev-cm.oriserve.com/createUser',
      {
        email: 'john.doe@company.com',
        password: 'SecureP@ss123',
        first_name: 'John',
...
def create_user():
    url = "https://seamless-sandbox-dev-cm.oriserve.com/createUser"
