...
### cURL:
```bash
curl -X POST "https://seamless-sandbox-dev-cm.oriserve.com/updateUser" \
...
async function updateUser(userId, updates) {
  try {
    const response = await axios.post(
      'https://seamless-sandbox-dev-cm.oriserve.com/updateUser',
      {
        userId,
        ...updates
      },
...
def update_user(user_id, **updates):
    url = "https://seamless-sandbox-dev-cm.oriserve.com/updateUser"
