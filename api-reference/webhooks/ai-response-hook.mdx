...
<Response>
  ...
  <GetInput 
    action="https://your-domain.com/responseHook"
    method="POST"
    inputType="speech"
    timeout="10"
    maxSpeechTime="60"
    speechTimeout="5"
    interimSpeechResultsCallback="https://your-domain.com/interim-results"
...
### cURL Request:
```bash
curl -X POST https://your-domain.com/responseHook \
...
response = requests.post(
    'https://your-domain.com/responseHook',
    headers={
