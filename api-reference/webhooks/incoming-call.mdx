...
<Response>
  ...
  <GetDigits 
    action="https://your-domain.com/ivr-menu" 
    method="POST"
    numDigits="1"
    timeout="10"
    finishOnKey="#">
...
<Response>
  ...
  <Record 
    action="https://your-domain.com/voicemail"
    method="POST"
    maxLength="120"
    timeout="10"
    finishOnKey="#"
    recordSession="false"
    redirect="true"
    callbackUrl="https://your-domain.com/recording-status"
    callbackMethod="POST" />
...
### cURL Example:
```bash
curl -X POST https://your-domain.com/oriIncomingCallHandler \
