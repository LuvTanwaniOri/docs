...
| --- | --- | --- | --- | --- |
| `callId` | string | ✅ Yes | - | The CallId of the voice session to audit |
| `auditSatisfaction` | string | ❌ No | - | QA satisfaction rating (e.g., `satisfied`, `neutral`, `unsatisfied`) |
| `issueText` | string | ❌ No | - | Detailed notes about issues found during the audit |
| `auditorId` | string | ✅ Yes | - | MongoDB ObjectId of the user performing the audit |
---
