...
# Fetch New Generative Bot Script

**Endpoint:** `POST /fetchNewGenerativeBotScript`
...
| --- | --- | --- | --- | --- |
| `userId` | string | ✅ Yes | - | MongoDB ObjectId of the user whose script data should be fetched |
---
