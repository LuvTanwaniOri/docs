...
# Initiate Batch Call Using Sheet

**Endpoint:** `POST /initiateBatchCallUsingSheet`
...
async function initiateBatchCallUsingSheet(filePath, agentId, campaignId) {
  ...
  console.log(`✅ ${response.data.data.total_contacts} contacts uploaded`);
...
def initiate_batch_call_using_sheet(file_path, agent_id, campaign_id=None):
    ...
    if response.status_code == 200:
        ...
        print(f"✅ Uploaded {result['total_contacts']} contacts")
