...
```
User speaks → Plivo transcribes → POST /responseHook
                                           ↓
                              ...
                              7. Generate XML response
                                           ↓
                              Return XML → Plivo speaks response → User hears
```
...
<Response>
  ...
  <GetInput 
    action="https://seamless-sandbox-dev-cm.oriserve.com/responseHook"
    method="POST"
    inputType="speech"
    timeout="10"
    maxSpeechTime="60"
    speechTimeout="5"
    interimSpeechResultsCallback="https://seamless-sandbox-dev-cm.oriserve.com/interim-results"
...
- **Negative** → Offer to transfer to manager
- **Neutral** → Ask clarifying questions
- **Positive** → Push towards demo/purchase
...
Speech: "मुझे आपकी प्रीमियम योजना के बारे में जानना है"

// AI responds in Hindi:
<Speak language="hi-IN">
  बहुत बढ़िया! हमारी प्रीमियम योजना में...
</Speak>
```
...
### cURL Request:
```bash
curl -X POST https://seamless-sandbox-dev-cm.oriserve.com/responseHook \
...
response = requests.post(
    'https://seamless-sandbox-dev-cm.oriserve.com/responseHook',
    headers={
