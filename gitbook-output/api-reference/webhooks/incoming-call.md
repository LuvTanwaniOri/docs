...
<Response>
  ...
  <GetDigits 
    action="https://seamless-sandbox-dev-cm.oriserve.com/ivr-menu" 
    method="POST"
    numDigits="1"
    timeout="10"
    finishOnKey="#">
...
<Response>
  ...
  <Record 
    action="https://seamless-sandbox-dev-cm.oriserve.com/voicemail"
    method="POST"
    maxLength="120"
    timeout="10"
    finishOnKey="#"
    recordSession="false"
    redirect="true"
    callbackUrl="https://seamless-sandbox-dev-cm.oriserve.com/recording-status"
    callbackMethod="POST" />
...
```
Caller dials number → Plivo receives call → POST to /oriIncomingCallHandler
                                                      ↓
...
### cURL Example:
```bash
curl -X POST https://seamless-sandbox-dev-cm.oriserve.com/oriIncomingCallHandler \
